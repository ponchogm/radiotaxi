...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2019 a las 06:02:55
...
('15678942-6', 'Juan', 'Castro', 'Morales', 'Maca 1544', '23457865', '96769022', 310);
...
--
-- Estructura de tabla para la tabla `conveniotipo`
--

CREATE TABLE `conveniotipo` (
  `ConvenioTipoCodigo` int(11) NOT NULL,
  `ConvenioTipoDesc` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `conveniotipo`
--

INSERT INTO `conveniotipo` (`ConvenioTipoCodigo`, `ConvenioTipoDesc`) VALUES
(1, 'Pago Fin de Mes');
...
(116, 2, NULL, '', '', '', 0, 0, 0),
(117, 2, '15475942-5', 'FKCJ-22', 'Toyota', 'Auris', 2015, 99, 125000);
...
(10, 451, 500, 1, '17-09-2019', '0'),
(11, 501, 550, 1, '17-09-2019', '0');
...
--
-- Estructura de tabla para la tabla `vales_cliente`
--

CREATE TABLE `vales_cliente` (
  `id` int(11) NOT NULL,
  `id_talonarioCliente` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `vales_cliente`
--

INSERT INTO `vales_cliente` (`id`, `id_talonarioCliente`, `id_cliente`, `id_adicional`, `id_convenio`, `numero_vale`, `direccion`, `origen`, `destino`, `fecha`, `hora`, `valor`, `observaciones`, `fecha_ingreso`, `MesCodigo`, `Periodo`, `usuario`) VALUES
(1, 1, 3248, 0, 0, 1, '', 'Casa', 'Trabajo', '09/09/2019', '14:44', 3500, 'primer vale de cliente', '10/09/2019', '09', 2019, ''),
(2, 5, 3200, 0, 0, 201, '', 'Casa', 'Trabajo', '10/09/2019', '12:53', 6700, 'Segunda Prueba de Vales clientes', '10/09/2019', '09', 2019, ''),
(3, 1, 3219, 0, 0, 2, '', 'Casa', 'Pega', '10/09/2019', '13:25', 2000, '', '10/09/2019', '09', 2019, '');
...
--
-- Indices de la tabla `conveniotipo`
--
ALTER TABLE `conveniotipo`
  ADD PRIMARY KEY (`ConvenioTipoCodigo`);
...
--
-- Indices de la tabla `vales_cliente`
--
ALTER TABLE `vales_cliente`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `conveniotipo`
--
ALTER TABLE `conveniotipo`
  MODIFY `ConvenioTipoCodigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `movil`
  MODIFY `MovilCodigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT de la tabla `talonario`
--
ALTER TABLE `talonario`
  MODIFY `TalonarioCodigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT de la tabla `vales_cliente`
--
ALTER TABLE `vales_cliente`
